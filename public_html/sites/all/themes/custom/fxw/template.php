<?php
function fxw_file_link($variables) {
  $file = $variables['file'];
 ...
 */
function fxw_preprocess_html(&$variables) {
 ...
 */
function fxw_js_alter(&$javascript) {
 ...
 */
function fxw_preprocess_page(&$variables) {
 ...
 */
function fxw_preprocess_node(&$variables) {
  $node = $variables['node'];
 ...
 */
function fxw_preprocess_comment(&$variables) {
 ...
 */
function fxw_node_view_alter(&$build) {
}
 ...
 */
function fxw_preprocess_node__full(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function fxw_preprocess_node__os2web_spotbox_box(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function fxw_preprocess_node__os2web_base_news(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function fxw_preprocess_node__os2web_cp_service_cp_document(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function fxw_preprocess_node__os2web_base_contentpage(&$variables) {
 ...
 */
function fxw_preprocess_taxonomy_term(&$variables) {
  $term = $variables['term'];
 ...
 * Implements template_preprocess_taxonomy_term().
 */
function fxw_preprocess_taxonomy_term__teaser(&$variables) {
 ...
 */
function fxw_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function fxw_preprocess_field(&$variables, $hook) {
 ...
 */
function fxw_menu_tree(&$variables) {
 ...
 * Implements theme_menu_tree().
 */
function fxw_menu_tree__tabbed(&$variables) {
  return $variables['tree'];
}
 ...
 */
function fxw_menu_link__tabbed(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
 ...
 */
function fxw_preprocess_breadcrumb(&$variables) {
